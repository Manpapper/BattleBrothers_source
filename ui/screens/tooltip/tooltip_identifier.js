...
var TooltipIdentifier =
{
	...
	CharacterNameAndTitles: 'CharacterNameAndTitles',
	...
	CharacterStats:
	{
		ActionPoints:		'character-stats.ActionPoints',
		Hitpoints:			'character-stats.Hitpoints',
		Morale:				'character-stats.Morale',
		Fatigue:			'character-stats.Fatigue',
		MaximumFatigue:		'character-stats.MaximumFatigue',
		ArmorHead:			'character-stats.ArmorHead',
		ArmorBody:			'character-stats.ArmorBody',

		MeleeSkill:			'character-stats.MeleeSkill',
		RangeSkill:			'character-stats.RangeSkill',
		MeleeDefense:		'character-stats.MeleeDefense',
		RangeDefense:		'character-stats.RangeDefense',
		SightDistance:		'character-stats.SightDistance',
		RegularDamage:		'character-stats.RegularDamage',
		CrushingDamage:		'character-stats.CrushingDamage',
		ChanceToHitHead:	'character-stats.ChanceToHitHead',
		Initiative:			'character-stats.Initiative',
		Bravery:			'character-stats.Bravery',

		Talent:				'character-stats.Talent',

		Undefined:			'character-stats.Undefined'
	},
	...
	MenuScreen:
	{
		...
		NewCampaign:
		{
			CompanyName: 'menu-screen.new-campaign.CompanyName',
			Seed: 'menu-screen.new-campaign.Seed',
		...
		Options:
		{
			DepthOfField: 'menu-screen.options.DepthOfField',
			UIScale: 'menu-screen.options.UIScale',
			SceneScale: 'menu-screen.options.SceneScale',

			EdgeOfScreen: 'menu-screen.options.EdgeOfScreen',
			DragWithMouse: 'menu-screen.options.DragWithMouse',
			HardwareMouse: 'menu-screen.options.HardwareMouse',

			CameraFollow: 'menu-screen.options.CameraFollow',
			CameraAdjust: 'menu-screen.options.CameraAdjust',
			StatsOverlays: 'menu-screen.options.StatsOverlays',
			OrientationOverlays: 'menu-screen.options.OrientationOverlays',
			MovementPlayer: 'menu-screen.options.MovementPlayer',
			MovementAI: 'menu-screen.options.MovementAI',
	...
	TacticalScreen:
	{
		...
		Topbar:
		{
			EventLogModule:
			{
				ExpandButton: 'tactical-screen.topbar.event-log-module.ExpandButton'
			},
	...
	WorldScreen:
	{
		...
		Obituary:
		{
			ColumnName: 'world-screen.obituary.ColumnName',
			ColumnTime: 'world-screen.obituary.ColumnTime',
	...
	WorldTownScreen:
	{
		MainDialogModule:
		{
			Contract: 'world-town-screen.main-dialog-module.Contract',
	...
	CharacterScreen:
	{
		...
		DismissPopupDialog:
		{
			Compensation: 'character-screen.dismiss-popup-dialog.Compensation'
		},
