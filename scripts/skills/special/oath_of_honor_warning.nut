this.oath_of_honor_warning <- this.inherit("scripts/skills/skill", {
	function create()
	{
		...
		this.m.Name = "Honorable Combat!";
		this.m.Icon = "skills/status_effect_160.png";
		this.m.IconMini = "status_effect_160_mini";
		this.m.Description = "This character has taken an Oath of Honor and refuses to use the currently equipped ranged weapon or tool!";
