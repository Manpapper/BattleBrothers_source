this.teamplayer_trait <- this.inherit("scripts/skills/traits/character_trait", {
	...
	function create()
	{
		...
		this.m.Description = "This character makes sure to always announce his intentions to his brothers-in-arms. In fact, he\'ll never shut the hell up. At least it reduces the chance of accidents happening.";
		this.m.Titles = [];
		this.m.Excluded = [
			"trait.cocky",
			"trait.bloodthirsty",
