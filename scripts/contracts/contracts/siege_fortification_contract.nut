this.siege_fortification_contract <- this.inherit("scripts/contracts/contract", {
	...
	function spawnReliefForces()
	{
		...
		local party = enemyFaction.spawnEntity(tile, this.m.Origin.getOwner().getName() + " Army", true, this.Const.World.Spawn.Noble, 200 * this.getDifficultyMult() * this.getScaledDifficultyMult(), this.getMinibossModifier());
