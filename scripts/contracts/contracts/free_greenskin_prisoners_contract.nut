this.free_greenskin_prisoners_contract <- this.inherit("scripts/contracts/contract", {
	...
	function createStates()
	{
		this.m.States.push({
			...
			function start()
			{
				this.Contract.m.BulletpointsObjectives = [
					"Search the battlesite %direction% of %origin% for clues",
		...
		this.m.States.push({
			...
			{
				this.Contract.m.BulletpointsObjectives = [
					"Follow the greenskin tracks leading away from the battle site",
					"Free any prisoners you find"
				];
		...
		this.m.States.push({
			...
			{
				this.Contract.m.BulletpointsObjectives = [
					"Return with the freed prisoners to " + this.Contract.m.Home.getName()
				];
