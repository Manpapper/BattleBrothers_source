...
gt.Const.AI <- {
	...
	Agent = {
		ID = {
			...
			LesserFleshGolem = "agent.lesser_flesh_golem",
			FleshGolemBodyguard = "agent.lesser_flesh_golem.bodyguard",
			GreaterFleshGolem = "agent.greater_flesh_golem",
			FaultFinder = "agent.fault_finder",
			GrandDiviner = "agent.grand_diviner"
		},
		Intentions = {
	...
	Properties = {
		...
		TargetPriorityStaggeredMult = 1.0,
	...
	Behavior = {
		...
		KnockBackCorpseDirectMult = 3.0,
		KnockBackCorpseIndirectMult = 1.8,
		KnockBackDangerTileMult = 3.5,
		KnockBackCorpseNotConsumableMult = 0.9,
		KnockBackAlreadyOnCorpseMult = 0.5,
		KnockBackAlreadyOnDangerTileMult = 0.5,
		...
		SplitShieldDestroyBonusMult = 1.5,
		...
		ExplodeCorpseWouldHitSelfValue = -500,
		ExplodeCorpseWouldHitAllyValue = -5,
		ExplodeCorpseTargetValue = 10,
		ChargeAttackWithAPLeftMult = 0.3,
		ChargeAttackExactAPMult = 1.3
	}
};
