this.forest2 <- this.inherit("scripts/mapgen/tactical_template", {
	m = {
		DetailsA = [
			"detail_forest_01",
			"detail_forest_02",
		...
		Objects = [
			...
			"entity/tactical/objects/brush_green",
			"entity/tactical/objects/tree_trunk_forest_leaves",
			"entity/tactical/objects/tree_trunk_forest_leaves",
			"entity/tactical/objects/tree_lush_small",
			"entity/tactical/objects/tree_lush_small"
		],
		ObjectsTreesSmall = [
			"entity/tactical/objects/tree_lush_smaller"
		],
		ObjectsTrees = [
	...
	function init()
	{
		this.m.Name = "tactical.tile.forest2";
		this.m.MinX = 1;
		this.m.MinY = 1;
		local t = this.createTileTransition();
		t.setBlendIntoSockets(false);
		t.setBrush(this.Const.Direction.N, "transition_forest_02_N");
		t.setBrush(this.Const.Direction.NE, "transition_forest_02_NE");
		t.setBrush(this.Const.Direction.SE, "transition_forest_02_SE");
		t.setBrush(this.Const.Direction.S, "transition_forest_02_S");
		t.setBrush(this.Const.Direction.SW, "transition_forest_02_SW");
		t.setBrush(this.Const.Direction.NW, "transition_forest_02_NW");
		t.setSocket("socket_earth");
		this.Tactical.setTransitions("tile_forest_02", t);
	}
