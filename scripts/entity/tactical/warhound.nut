this.warhound <- this.inherit("scripts/entity/tactical/actor", {
	...
	function create()
	{
		this.m.Type = this.Const.EntityType.Warhound;
		this.m.BloodType = this.Const.BloodType.Red;
		this.m.XP = this.Const.Tactical.Actor.Warhound.XP;
	...
	{
		this.m.Items.getAppearance().Body = "bust_hound_0" + _v + "_body";
		this.getSprite("body").setBrush("bust_hound_0" + _v + "_body");
		this.getSprite("head").setBrush("bust_hound_0" + _v + "_head");
		this.setDirty(true);
	}
