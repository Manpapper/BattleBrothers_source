this.scenario_line_battle_orcs <- this.inherit("scripts/scenarios/tactical/scenario_template", {
	m = {},
	function generate()
	{
		...
		this.m.Music = this.Const.Music.OrcsTracks;
	...
	function initEntities()
	{
		...
		items.addToBag(this.new("scripts/items/weapons/dagger"));
		entity = this.spawnEntity("scripts/entity/tactical/player", 10, 10, 13, 13);
		this.World.getPlayerRoster().add(entity);
		entity.setName(this.getRandomPlayerName());
		entity.setScenarioValues();
		items = entity.getItems();
		items.equip(this.new("scripts/items/armor/leather_lamellar"));
		items.equip(this.new("scripts/items/tools/player_banner"));
		items.addToBag(this.new("scripts/items/weapons/dagger"));
		...
		entity.setScenarioValues();
		items = entity.getItems();
		items.equip(this.new("scripts/items/helmets/flat_top_helmet"));
		items.equip(this.new("scripts/items/armor/mail_shirt"));
		...
		local x;
		x = 19;
		entity = this.spawnEntity("scripts/entity/tactical/enemies/orc_berserker", x, x, 11, 11);
		entity.setFaction(this.Const.Faction.Orcs);
		entity.assignRandomEquipment();
		entity = this.spawnEntity("scripts/entity/tactical/enemies/orc_young", x, x, 12, 12);
		entity.setFaction(this.Const.Faction.Orcs);
		entity.assignRandomEquipment();
		entity = this.spawnEntity("scripts/entity/tactical/enemies/orc_young", x, x, 13, 13);
		entity.setFaction(this.Const.Faction.Orcs);
		entity.assignRandomEquipment();
		...
		entity.setFaction(this.Const.Faction.Orcs);
		entity.assignRandomEquipment();
		entity = this.spawnEntity("scripts/entity/tactical/enemies/orc_warrior", x, x, 13, 13);
		entity.setFaction(this.Const.Faction.Orcs);
		entity.assignRandomEquipment();
		entity = this.spawnEntity("scripts/entity/tactical/enemies/orc_warlord", x, x, 14, 14);
		entity.setFaction(this.Const.Faction.Orcs);
		entity.assignRandomEquipment();
		entity = this.spawnEntity("scripts/entity/tactical/enemies/orc_young", x, x, 15, 15);
		entity.setFaction(this.Const.Faction.Orcs);
