this.scenario_line_battle_goblins <- this.inherit("scripts/scenarios/tactical/scenario_template", {
	m = {},
	function generate()
	{
	...
	function initEntities()
	{
		...
		entity.setFaction(this.Const.Faction.Goblins);
		entity.assignRandomEquipment();
		entity = this.spawnEntity("scripts/entity/tactical/enemies/goblin_ambusher", 20, 20, 13, 13);
		entity.setFaction(this.Const.Faction.Goblins);
		entity.assignRandomEquipment();
		entity = this.spawnEntity("scripts/entity/tactical/enemies/goblin_leader", 20, 20, 14, 14);
		entity.setFaction(this.Const.Faction.Goblins);
		entity.assignRandomEquipment();
		entity = this.spawnEntity("scripts/entity/tactical/enemies/goblin_shaman", 20, 20, 15, 15);
		entity.setFaction(this.Const.Faction.Goblins);
		entity.assignRandomEquipment();
