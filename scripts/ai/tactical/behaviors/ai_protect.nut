this.ai_protect <- this.inherit("scripts/ai/tactical/behavior", {
	m = {
		TargetTile = null,
	...
	function onEvaluate( _entity )
	{
		...
		foreach( a in allies )
		{
			if (a.getCurrentProperties().TargetAttractionMult > 1.0 && a.getAIAgent().getBehavior(this.Const.AI.Behavior.ID.Protect) == null)
			{
